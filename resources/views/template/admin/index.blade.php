...
<head>
  ...
  <title>Portofolio - Ahmad Risyfa</title>
  ...
  <!-- =======================================================
  * Template Name: Ahmad Risyfa - v2.4.1
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{url('admin/dashboard')}}" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Ahmad Risyfa</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link @if(!request()->is('admin/about_me')) collapsed @endif" href="{{ url('admin/about_me') }}">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{asset('template_admin')}}/components-accordion.html">
              <i class="bi bi-circle"></i><span>Accordion</span>
            </a>
          </li>
          <li>
            <a href="{{asset('template_admin')}}/components-badges.html">
              <i class="bi bi-circle"></i><span>Badges</span>
            </a>
          </li>
          <li>
            <a href="{{asset('template_admin')}}/components-breadcrumbs.html">
          ...
          <li>
            <a href="{{asset('template_admin')}}/components-cards.html">
              <i class="bi bi-circle"></i><span>Cards</span>
            </a>
          </li>
          <li>
            <a href="{{asset('template_admin')}}/components-carousel.html">
              <i class="bi bi-circle"></i><span>Carousel</span>
            </a>
          </li>
          <li>
            <a href="{{asset('template_admin')}}/components-list-group.html">
              <i class="bi bi-circle"></i><span>List group</span>
            </a>
          </li>
          <li>
            <a href="{{asset('template_admin')}}/components-modal.html">
              <i class="bi bi-circle"></i><span>Modal</span>
            </a>
          </li>
          <li>
            <a href="{{asset('template_admin')}}/components-tabs.html">
              <i class="bi bi-circle"></i><span>Tabs</span>
            </a>
          </li>
          <li>
            <a href="{{asset('template_admin')}}/components-pagination.html">
              <i class="bi bi-circle"></i><span>Pagination</span>
            </a>
          </li>
          <li>
            <a href="{{asset('template_admin')}}/components-progress.html">
              <i class="bi bi-circle"></i><span>Progress</span>
            </a>
          </li>
          <li>
            <a href="{{asset('template_admin')}}/components-spinners.html">
              <i class="bi bi-circle"></i><span>Spinners</span>
            </a>
          </li>
          <li>
            <a href="{{asset('template_admin')}}/components-tooltips.html">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Ahmad Risyfa</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
